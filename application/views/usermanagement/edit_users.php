...
<section class="content-header">
          ...
          <form role="form"method="post" action="<?php echo base_url();?>users-update" enctype="multipart/form-data">
                    ...
                    <label for="exampleInputname1">Name*</label>
                      <input type="text" id="name" required name="name" class="form-control" id="name" value="<?php  echo $values[0]->user_name;?>" >
                      <input type="hidden" name="id" id="id"  value="<?php  echo $values[0]->id;?>" />
                    
                    </div>
                    <div class="form-group col-md-6 ">
                    <label for="exampleInputEmail1">Email*</label>
                      <input type="email"  required name="email" class="form-control" id="email" value="<?php  echo $values[0]->email;?>" >
                    </div>
                    <div class="form-group col-md-6">
                    <label for="exampleInputPassword1">Password*</label>
                      <input type="text" required id="password" name="password" class="form-control"  value="<?php  echo $values[0]->password;?>">
                    </div>
                    <div class="form-group col-md-6 ">
