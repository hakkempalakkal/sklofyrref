...
<div class="row">
   <div class="col-md-12 ">
      ...
      <input class="form-control" id="post_date" value="<?php  echo $debitdata[0]->PostingDate; ?>" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
              <div class="form-group col-md-2">
                  <label class="control-label" for="date">Inv Date</label>
      <input class="form-control" id="inv_date" value="<?php  echo $debitdata[0]->InvDate; ?>" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
              ...
              <div class="form-group col-md-2">
                  ...
                  <input maxlength="100" type="text" value="<?php  echo $debitdata[0]->Reference; ?>" id="invoice" required="required" class="form-control" placeholder=" invoice" value="">
              </div>
              <div class="form-group col-md-1">
                  <label class="control-label" for="date">Our Inv</label>
                  <input maxlength="100" type="text" value="<?php  echo $debitdata[0]->OurInv; ?>" id="invoice_id" required="required" class="form-control" placeholder=" invoice" value="">
              </div>
              <div class="form-group col-md-2">
              ...
              <div class="col-md-12" style="border-bottom:1px solid #eee; margin-bottom:10px; height:2px;"></div>
                        ...
                        <div class="row">
                           <div class="form-group col-md-1">
                              ...
                              <input maxlength="100"  onchange="get_desdatas();" type="text" id="desc_code" name="desc_code" required="required" class="form-control" placeholder=" code" />
                           </div>
                           <div class="form-group col-md-2">
