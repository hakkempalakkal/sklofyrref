...
class Job_supplier_payment_model extends CI_Model
{
   ...
   {
      $data = "select * from jm_expensemaster
...
// die();
   ...
   public function deletesupplierpayment($Id)
   {
    ...
    $dataq="select ji.ID,ji.Date,ji.VatTotal,ji.SubTotal,concat(c.supplier_name,'|',c.address,'|',c.telephone,'-',c.mobile,'|',c.email) as supplierenglish,c.vat_no,
