   ...
   <div class="col-md-12 ">
      <div class="panel panel-primary " >
         <div class="panel-heading">
            <h3 class="panel-title">Payment To Supplier</h3>
         </div>
                     ...
                     <div class="box-body">
                        <div class="row">
                           <div class="form-group col-md-2">
                              ...
                              <input   type="text" id="code" required="required" class="form-control" readonly="readonly"  placeholder="<?php echo $Invcode[0]->ID+1;?>"  value="<?php echo $Invcode[0]->ID+1;?>"/>
                     ...
                     <div class="col-md-12 ">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-4" id="chequeno">
                              ...
                              <input maxlength="100" type="text" id="cheque_no"  class="form-control " placeholder="Cheque No" />
                           </div>
                           <div class="form-group col-md-4" id="chequedate">
                              <label class="control-label">Cheque Date</label>
                              <input maxlength="100" type="date" id="cheque_date"  class="form-control " placeholder=" " />
                           </div>
                           ...
                           <div class="form-group col-md-2">
                              <input type="button"  style=" margin-top:20px;" value="Submit" id="submit" onclick="insert_supplier_payment();" class="btn btn-success"  >
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-2">
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="box-body">
                        ...
                        <p class="text-muted">
                        <?php echo $supplier[0]->supplier_name;?>
                        </p>
                        <hr>
                        <strong><i class=""></i> Address</strong>
                        <p class="text-muted">   <?php echo $supplier[0]->address;?></p>
                        <hr>
                        <strong><i class=""></i> Country</strong>
                        <p class="text-muted">    <?php echo $supplier[0]->country;?>  </p>
                        <hr>
                        <strong><i class=""></i> Tele: </strong>
                        <p>  <?php echo $supplier[0]->telephone;?></p>
                        <hr>
                        <strong><i class=""></i>Mobile</strong>
                        <p>   <?php echo $supplier[0]->mobile;?> </p>
                        <hr>
                        <strong><i class=""></i>Email</strong>
                        <p>   <?php echo $supplier[0]->email;?></p>
