              ...
              <div class="col-md-12" style="border-bottom:1px solid #eee; margin-bottom:10px; height:2px;"></div>
                        ...
                        <div class="row">
                           <div class="form-group col-md-1">
                              ...
                              <input maxlength="100"  onchange="getdatas();" type="text" id="desc_code" name="desc_code" required="required" class="form-control" placeholder=" code" />
                           </div>
                           <div class="form-group col-md-2">
                     ...
                     <div class="col-md-12 ">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input class=" btn btn-success" type="button" name="add_expense" onclick="insert_debitnote_details();" style=" margin-top:20px;" value="Submit" id="add_expense">
                           </div>
                        </div>
                     </div>
                  </div>
...
<script src="<?php echo base_url(); ?>/assets/user_scripts/transaction/debit_note.js"></script>
<script>
