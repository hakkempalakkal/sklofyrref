                                    ...
                                    <table class="cus-con">
                                        ...
                                        <tr style="height: 107px;">
                                            ...
                                            <td style="vertical-align: text-top; font-size: 13px;">
                                                <span id="lblClient"></span>
                                                      ...
                                                      <?php echo $debitdata[0]->clientenglish;?>
                                                        <br />
                                                      
                                                            <br />
                                                            <?php echo $debitdata[0]->clientearabic;?>
                                        ...
                                        <tr style="height: 93px; font-size: 13px;">
                                            ...
                                            <td style="vertical-align: text-top;">
                                                <p>
                                                    <span id="lblShiper"><?php echo $debitdata[0]->consignor;?></span>
                                                </p>
                                        ...
                                        <tr style="height: 93px; font-size: 13px;">
                                            ...
                                            <td style="vertical-align: text-top;">
                                                <?php echo $debitdata[0]->consignee;?>
                                ...
                                <td style="width: 33%;">
                                    <table class="cus-con" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 33px; font-size: 13px;"><?php echo $debitdata[0]->awb;?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 33px; font-size: 13px;"><?php echo $debitdata[0]->ActualWeight;?> &nbsp;&nbsp;KGS
                                                    </td>
                                                </tr>
                                         ...
                                         <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 50px; font-size: 13px;">
                                                        <span id="lblPono"><?php echo $debitdata[0]->PostingDate;?> </span>
                                                    </td>
                                                </tr>
                                    ...
                                    <table class="cus-con">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblJobNo"><?php echo $debitdata[0]->Number;?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblCustomerVat"><?php echo $debitdata[0]->vat_no;?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblVendorId"><?php echo $debitdata[0]->Etd;?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblEta"><?php echo $debitdata[0]->Eta;?></span>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: center; width:12.6%">
                                        <span id="lblTotal"> <?php echo $debitdata[0]->SubTotal;?></span>
                                    </td>
                                </tr>
                                <tr>
