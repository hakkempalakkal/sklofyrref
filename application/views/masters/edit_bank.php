       ...
       <div class="box-body">
          <form role="form">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" id="name"  name="name" class="form-control"  value="<?php  echo $value[0]->bank_name;?>"  id="name"  >
                    ...
                    <div class="form-group col-md-6 ">
                     ...
                     <?php if($value[0]->acc_type!="current"){ ?>  <option value="current">Current</option><?php } ?> 
                                ...
                                <div class="form-group col-md-6">
									...
									<input type="text" class="form-control" id="acc-no" name="acc-no" value="<?php  echo $value[0]->acc_number;?>" >
								
                                </div>
                                <div class="form-group col-md-6">
									<label>IBAN</label>
									
										<input type="text" class="form-control" id="iban" name="iban" value="<?php  echo $value[0]->iban;?>" >
								
                                </div>
                                <div class="form-group col-md-6">
									<label>Opening Balance</label>
									
										<input type="text" class="form-control" id="opbal" name="opbal" value="<?php  echo $value[0]->opening_bal;?>" >
