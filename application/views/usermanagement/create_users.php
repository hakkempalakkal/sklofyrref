...
<section class="content">
  <div class="box box-success ">
    <div class="box-body" style="min-height:500px;">
      <form role="form" method="post" action="<?php echo base_url(); ?>users-store" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" id="name" required name="name" class="form-control" id="name" placeholder="Enter name">
        </div>
        <div class="form-group col-md-6">
          <label for="exampleInputEmail1">Email*</label> <span id='emailmessage'></span>
          <input type="email" id="email" required name="email" class="form-control" onblur="checkMailStatus()" placeholder="Enter email">
        </div>
        <div class="form-group col-md-6 ">
        ...
        <div class="form-group col-md-6 ">
          ...
          <input type="password" required id="cpassword" name="cpassword" onkeyup='check();' class="form-control" placeholder="confirm Password">
        </div>
        <div class="form-group col-md-6 ">
    ...
    <div class="box-footer">
      <button type="submit" onclick="setTimeout(useradd,100);" class="btn btn-success">Save</button>
