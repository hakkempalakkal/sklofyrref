...
<div class=" row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" required id="client_vat" placeholder="Enter VAT number">
                    </div></div>
                    
                    <div class=" row">
                    <div class="form-group col-md-6">
                      <label for="code">Country</label>
                      <input type="text" class="form-control" required id="client_country" placeholder="Enter country">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" required id="client_remarks" placeholder="Enter remarks">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" required id="client_telephone" placeholder="Enter telephone">
                    </div></div>
                    <div class=" row">
                    <div class="form-group col-md-6">
                      <label for="code">Mobile</label>
                      <input type="text" class="form-control" required id="client_mobile" placeholder="Enter mobile ">
                    </div>  </div>
                    <div class=" row">
                    <div class="form-group col-md-6">
                      <label for="code">Fax</label>
                      <input type="text" class="form-control" required id="client_fax" placeholder="Enter fax">
                    </div>  </div>
                    <div class=" row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" required id="client_email" name="client_email"   placeholder="Enter email">
