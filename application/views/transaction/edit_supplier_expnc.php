         ...
         <div class="panel-body">
            ...
            <div class="col-md-10">
               ...
               <div class="box box-primary">
                ...
                <div class="form-group col-md-2">
                  <label class="control-label" for="date">Posting Date</label>
                       <input class="form-control" value="<?php  echo $expensedata[0]->PostingDate; ?>" id="post_date" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>
              <div class="form-group col-md-2">
                  <label class="control-label" for="date">Inv Date</label>
                       <input class="form-control"  value="<?php  echo $expensedata[0]->InvDate; ?>" id="inv_date" name="date" placeholder="YYY/MM/DD" type="text"/>
              </div>

                <div class="form-group col-md-2">
                  <label class="control-label" for="date">Select Supplier</label>
                  <input maxlength="100" type="text"  value="<?php  echo $expensedata[0]->supplier_name; ?>" id="view_supplier_name" required="required" class="form-control" placeholder=" supplier_name" value="">
              ...
              <div class="form-group col-md-2">
                  ...
                  <input maxlength="100" type="text" value="<?php  echo $expensedata[0]->Reference; ?>" id="invoice" required="required" class="form-control" placeholder=" invoice" value="">
              </div>
              <div class="form-group col-md-1">
                  <label class="control-label" for="date">Our Inv</label>
                  <input maxlength="100" type="text" value="<?php  echo $expensedata[0]->OurInv; ?>" id="invoice_id" required="required" class="form-control" placeholder=" invoice" value="">
              </div>
              <div class="form-group col-md-2">
