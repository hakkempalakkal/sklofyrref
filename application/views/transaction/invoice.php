...
<body>
            ...
            <div class="container">
                <div class="row">
                    <a id="btnHome" style="float: left;" href="http://aotlogisticsapp.com/Index.aspx" class="btn btn-default">Home</a>
                    <a id="btnBack" style="float: left;" href="http://aotlogisticsapp.com/masters/invoices.aspx" class="btn btn-default">Make Another Invoice</a>
                                ...
                                <td style="width: 33%;">
                                    <table class="cus-con" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 33px; font-size: 13px;"><?php echo $invoicedata[0]->awb;?>
