...
$(".ledgerdatatable").html("");
        ...
        $(".ledgerdatatable").append( "<tr class='tbl_row' ><td  colspan='4'>Total</td> <td>"+creditsum+"</td> <td class='type'>"+debitsum+"</td></tr>" );
        ...
        if(creditsum>debitsum)
{
  ...
  balance=(debitsum-creditsum).toFixed(2);
        $(".ledgerdatatable").append( "<tr class='tbl_row' ><td  colspan='4'>Balance</td> <td>0</td> <td class='type'>"+balance+"</td></tr>" );
}
