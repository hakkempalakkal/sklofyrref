   ...
   <div class="col-md-12 ">
      <div class="panel panel-primary setup-content " >
         <div class="panel-heading">
            <h3 class="panel-title">Edit Supplier Payment</h3>
         </div>
                     ...
                     <div class="box-body">
                        <div class="row">
                           <div class="form-group col-md-1">
                              ...
                              <input   type="text" id="code" required="required" class="form-control" readonly="readonly"  placeholder="<?php echo $supplierpaymentdata[0]->ID;?>"  value="<?php echo $supplierpaymentdata[0]->ID;?>"/>

                           </div>
                           <div class="form-group col-md-2">
                              <label class="control-label">Date</label>
                              <input type="date" value="<?php echo $supplierpaymentdata[0]->Date;?>" class="form-control" required id="date" name="date" ></input>
                              <input maxlength="100" type="hidden" id="master_id"  class="form-control"  value="<?php echo $supplierpaymentdata[0]->SupplierPaymentMasterId;?>"/>
                        ...
                        <div class="form-group col-md-2">
                                 ...
                                 <select class="form-control" id="inv_id" name="inv_id" onchange="clientdetails();" value="">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input maxlength="100" type="text" id="amount" required="required" class="form-control" placeholder=""  value=""/>
                           </div>
                              <div class="form-group col-md-2">
                                 <label class="control-label"></label>
                              ...
                              <div class="">
                                 <div id="ContentPlaceHolder1_upDataList">
                                    <table id="datatable" class="table table-striped table-bordered">
                                       ...
                                       <tbody class="dataadd"> 
                                       <?php
                                       foreach($jobsupplierpaymentdata as $key=>$value)
                                       {
                                          ?>
                                      <tr>
                                      <td class='inv'><?php echo $value->SupplierExpenseMasterID;?> </td>
                                       ...
                                       <td class='amount'><?php echo $value->Amount;?> </td>
                                        ...
                                        <td class='cov_factor'><?php echo $value->ConvFactor;?> </td>
                                          ...
                                          <td>
                                          <a class="" onclick="deletedids(<?php echo $value->SupplierPaymentDetailId; ?>,this)"><i class="fa fa-trash-o"></i></a>
                    ...
                    ?>
                                 ...
                                 <div id="ContentPlaceHolder1_upTotals">
                                    <div style="float: right;">
                                       ...
                                       <input name="total" type="text" value="<?php echo $supplierpaymentdata[0]->SubTotal;?> " readonly="readonly" id="total" class="form-control " style="width: 100%;">
                                       ...
                                       <input name="grand_total" type="text" value="<?php echo $supplierpaymentdata[0]->SubTotal;?> " readonly="readonly" id="grand_total" class="form-control " style="width: 100%;">                 
                                    </div>
                                 </div>
                                 <!-- /.box-body -->
                              </div>
                     ...
                     <div class="col-md-12 ">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <option value="<?php echo $supplierpaymentdata[0]->Mode; ?>"><?php echo $supplierpaymentdata[0]->Mode; ?></option>
                                 <?php if($supplierpaymentdata[0]->Mode!="cash"){ ?>  <option value="cash">Cash</option><?php } ?> 
                                 <?php if($supplierpaymentdata[0]->Mode!="cheque"){ ?>  <option value="cheque">Cheque</option><?php } ?> 
                                 <?php if($supplierpaymentdata[0]->Mode!="electronic"){ ?>  <option value="electronic">Electronic</option><?php } ?> 

                              </select>
                           </div>
                           <div class="form-group col-md-4" id="chequeno">
                              <label class="control-label">   Cheque No:</label>
                              <input maxlength="100" type="text" id="cheque_no"  class="form-control " placeholder="Cheque No" value="<?php echo $supplierpaymentdata[0]->ChequeNo;?> "/>
                           </div>
                           <div class="form-group col-md-4" id="chequedate">
                              <label class="control-label">Cheque Date</label>
                              <input maxlength="100" type="date" id="cheque_date"  class="form-control " placeholder=" " value="<?php echo $supplierpaymentdata[0]->ChequeDate;?> " />
                           </div>
                           ...
                           <div class="form-group col-md-2">
                              <input type="button"  style=" margin-top:20px;" value="Submit" id="submit"  class="btn btn-success" onclick="update_supplier_payment();" >
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-2">
                  ...
                  <div class="box box-primary">
                     ...
                     <div class="box-body">
                        ...
                        <p class="text-muted">
                        <?php echo $supplierpaymentdata[0]->supplier_name;?>
                        </p>
                        <hr>
                        <strong><i class=""></i> Address</strong>
                        <p class="text-muted">
                        <?php echo $supplierpaymentdata[0]->address;?>
                           </p>
                        <hr>
                        <strong><i class=""></i> Country</strong>
                        <p class="text-muted"> 
                            <?php echo $supplierpaymentdata[0]->country;?>  
                           </p>
                        <hr>
                        <strong><i class=""></i> Tele: </strong>
                        <p> 
                        <?php echo $supplierpaymentdata[0]->telephone;?>
                         </p>
                        <hr>
                        <strong><i class=""></i>Mobile</strong>
                        <p>  
                        <?php echo $supplierpaymentdata[0]->mobile;?>
                          </p>
                        <hr>
                        <strong><i class=""></i>Email</strong>
                        <p> 
                        <?php echo $supplierpaymentdata[0]->email;?> 
                        </p>
...
<script src="<?php echo base_url(); ?>/assets/user_scripts/transaction/edit_job_supplier_payment.js"></script>
