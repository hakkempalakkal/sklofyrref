                     ...
                     <div class="box-body">
                        <div class="row">
                           ...
                           <div class="form-group col-md-3">
                              ...
                              <input type="date" value="<?php echo $invoicedata[0]->Date; ?>" class="form-control" required id="date" name="date" ></input>
                           ...
                           <div>
                              ...
                              <td class="job_desc"><?php echo $value->Description; ?> </td>
                               ...
                               <td class='job_quantity'><?php echo $value->Quantity; ?></td>
                                <td class="subtotalval_data"><?php echo $value->Total; ?></td> 
                                <td class="taxval_data"><?php echo $value->Vat; ?> </td>
                                 <td class="totalval_data"><?php echo $value->Total+$value->Vat; ?></td>
                                  <td>
