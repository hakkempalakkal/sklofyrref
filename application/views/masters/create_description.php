          ...
          <form role="form">
                ...
                <input type="text" id="description_code"  name="description_code" class="form-control" readonly="readonly" placeholder="<?php echo $code[0]->code+1;?>"  value="<?php echo $code[0]->code+1;?>">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" required id="description_name" placeholder="Enter description">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="code">Description Arabic</label>
                      <input type="text" class="form-control" required id="description_arabic" placeholder="Enter description arabic">
                    </div>
