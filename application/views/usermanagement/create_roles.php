          ...
          <form role="form">
                  <div class="box-body"  style="min-height: 300px;">
                    <div class="form-group col-md-6 ">
                      ...
                      <input type="text" class="form-control" id="role_name" placeholder="Enter name"  required/>
                    </div>
                    <div class="form-group col-md-6 ">
                      <label for="code">Code</label>
                      <input type="text" class="form-control" id="role_code" placeholder="Enter code" required/>
                  
                    </div>
                    <div class="form-group col-md-12 ">
                      <label>Description</label>
                      <textarea class="form-control" id="role_description" rows="3" placeholder="enter description"  required></textarea>
                    </div>
                    <div class="form-group col-md-12 ">
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="col-md-3">
                    ...
                    <input type="checkbox" class="minimal readpermissions readselect "  id="permissionread" name="permissionread[]"  value="<?php echo $value1->id;?>"  /><?php echo ' '.$value1->display_name; ?></label> 
                ...
                <div class="col-md-3">
                    <label class="input-checkbox">
                      <input type="checkbox" class="minimal readpermissions createpermissions"  id="permissioncreate" name="permissioncreate[]" value="<?php echo $value1->id;?>"/><?php echo ' '.$value1->display_name; ?>
                ...
                <div class="col-md-3">
                    <label class="input-checkbox">
                      <input type="checkbox" class="minimal readpermissions updatepermissions"  id="permissionupdate" name="permissionupdate[]" value="<?php echo $value1->id;?>"/><?php echo ' '.$value1->display_name; ?>
...
<script>
  ...
  $('input[type="checkbox"].minimal, input[type="radio"].minimal').iCheck({
    checkboxClass: 'icheckbox_square-green'
      ...
      $('.readpermissions').iCheck('check');
      });
      $('.unselectall-all').click(function(){
      $('.readpermissions').iCheck('uncheck');
      });
