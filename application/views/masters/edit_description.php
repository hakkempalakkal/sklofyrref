          ...
          <form role="form">
                  <div class="box-body" style="min-height: 300px; " >
                    ...
                    <div class="form-group col-md-6 ">
                      ...
                      <input type="text" class="form-control" id="description_name"  value="<?php  echo $value[0]->description; ?>" >
                    </div>
                    <div class="form-group col-md-6 ">
                      <label for="code">Description Arabic</label>
                      <input type="text" class="form-control" id="description_arabic"  value="<?php  echo $value[0]->description_arabic; ?>">
                    </div>
