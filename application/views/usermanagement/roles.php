<section class="content-header">
   <h1>
      ...
      <?php 
             ...
             if (in_array("create role", $permission))
             {  ?> 
   <span class="new-button"><a href="<?php echo base_url(); ?>roles-create" class="btn btn-success btn-sm"><span class="fa fa-plus"></span> &nbsp;Add New</a></span>
   <?php
              }
                ?>
    </h1>
