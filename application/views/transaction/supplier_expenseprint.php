...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <a id="btnBack" style="float: left;" href="<?php echo base_url(); ?>supplier-expense" class="btn btn-default">Make Another Invoice</a>
                                    ...
                                    <table class="cus-con">
                                                ...
                                                <span id="lblClient"></span>
                                                      ...
                                                      <?php echo $expdata[0]->clientenglish;?>
                                                        <br />
                                                            ...
                                                            <br />
                                                            <?php echo $expdata[0]->clientearabic;?>
                                        ...
                                        <tr style="height: 93px; font-size: 13px;">
                                            ...
                                            <td style="vertical-align: text-top;">
                                                <p>
                                                    <span id="lblShiper"><?php echo $expdata[0]->consignor;?></span>
                                                </p>
                                ...
                                <td style="width: 33%;">
                                    <table class="cus-con" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 33px; font-size: 13px;"><?php echo $expdata[0]->awb;?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 33px; font-size: 13px;"><?php echo $expdata[0]->ActualWeight;?> &nbsp;&nbsp;KGS
                                                    </td>
                                                </tr>
                                         ...
                                         <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 50px; font-size: 13px;">
                                                        <span id="lblPono"><?php echo $expdata[0]->PostingDate;?> </span>
                                                    </td>
                                                </tr>
                                    ...
                                    <table class="cus-con">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblJobNo"><?php echo $expdata[0]->Number;?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblCustomerVat"><?php echo $expdata[0]->vat_no;?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblVendorId"><?php echo $expdata[0]->Etd;?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 33px!important; font-size: 13px;">
                                                <span id="lblEta"><?php echo $expdata[0]->Eta;?></span>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: center; width:12.6%">
                                        <span id="lblTotal"> <?php echo $expdata[0]->SubTotal;?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" >VALUE ADDED TAX (VAT) @ 5%
                                        <label class="rtl">ضريبة القيمة المضافة - القيمة الاعتيادية %5</label>
