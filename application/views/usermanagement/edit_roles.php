          ...
          <form role="form">
                  <div class="box-body">
                    <div class="form-group  col-md-6 ">
                      ...
                      <input type="text" class="form-control" id="role_name" value="<?php  echo $value[0]->display_name; ?>" placeholder="Enter name">
                      <input type="hidden" name="id" id="id"  value="<?php  echo $value[0]->id;?>" />
                    </div>
                    <div class="form-group  col-md-6">
                      <label for="code">Code</label>
                      <input type="text" class="form-control" id="role_code"  value="<?php  echo $value[0]->name; ?>" placeholder="Enter code">
                    </div>
                    <div class="form-group  col-md-12">
                      <label>Description</label>
                      <textarea class="form-control" rows="3" id="role_description" placeholder="enter description"><?php  echo $value[0]->description; ?></textarea>
                    </div>
                    <div class="form-group col-md-12 ">
